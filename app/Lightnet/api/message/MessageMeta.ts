...
import { MessageMetaMapping } from '../mapping/message/MessageMetaMapping';
import { MessageMetaModel } from '../model/message/MessageMetaModel';
import { PROTOCOL_VERSION } from '../ProtocolVersion';
import { Crc } from '../../crc';
import { MetaMapping } from '../mapping/MetaMapping';
import { HeaderMapping } from '../mapping/HeaderMapping';
...
export class MessageMeta<TModel extends MessageMetaModel = MessageMetaModel> extends Message<TModel> {
  ...
  updateChecksums() {
    this.metaMapping
      .getMapping('payloadSize')
      .setValue(this.mapping.getEndOffset() - this.payloadMapping.getEndOffset());
