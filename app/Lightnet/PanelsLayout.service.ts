...
import { EdgeCoords } from './model/EdgeCoords';
...
export class PanelsLayoutService {
  ...
  protected static buildLayout(panelInfo: PanelInfo, layouts: LayoutsMap, edgeLength: number): PanelLayout {
    ...
    if (parentEdgeCoords) {
      ...
      this.movePanel(layout, parentEdgeCoords.x2 - rootEdge.x1, parentEdgeCoords.y2 - rootEdge.y1);
  ...
  private static generateEdgeCoords(
    layout: PanelLayout,
    panelInfo: PanelInfo,
    edgeIndex: number,
    edgeLength: number,
